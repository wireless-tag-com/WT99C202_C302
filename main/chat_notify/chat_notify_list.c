...
chat_notify_t chat_notify_list[MAX_NOTIFY_TYPE] = {
    ...
    // 电池管理相关通知
    [NOTIFY_BAT_LOW_POWER] = {
        .notify_id = NOTIFY_BAT_LOW_POWER, .path = "bat_low_power", .enable = 1,
        .tts_sync_type = TTS_SYNC_FROM_FILE, .tts_text = "电池电量不足, 请及时充电",
    },
    [NOTIFY_BAT_CRITICAL] = {
        .notify_id = NOTIFY_BAT_CRITICAL, .path = "bat_critical", .enable = 1,
        .tts_sync_type = TTS_SYNC_FROM_FILE, .tts_text = "电池电量极低, 系统即将关机, 请立即充电",
    },
    [NOTIFY_BAT_USB_PLUG] = {
        .notify_id = NOTIFY_BAT_USB_PLUG, .path = "bat_usb_plug", .enable = 1,
        .tts_sync_type = TTS_SYNC_FROM_FILE, .tts_text = "开始充电",
    },
    [NOTIFY_BAT_CHARGE_FULL] = {
        .notify_id = NOTIFY_BAT_CHARGE_FULL, .path = "bat_charge_full", .enable = 1,
        .tts_sync_type = TTS_SYNC_FROM_FILE, .tts_text = "电池充电完成",
    },
};
